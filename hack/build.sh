...
LDFLAGS_VALUE="-X github.com/medik8s/storage-based-remediation/v5/pkg/version.GitCommit=${COMMIT} "
LDFLAGS_VALUE+="-X github.com/medik8s/storage-based-remediation/v5/pkg/version.GitDescribe=${VERSION} "
LDFLAGS_VALUE+="-X github.com/medik8s/storage-based-remediation/v5/pkg/version.BuildDate=${BUILD_DATE} "
